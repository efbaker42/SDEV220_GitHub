...
urlpatterns = [
    ...
    path('sheet/<int:pk>/', views.sheet_detail, name='sheet_detail'), #doesn't do anything yet; need sheet_detail view and html template
    path('sheet/new/', views.character_sheet_new, name='new_sheet'), #name is the name of the url; may be referenced elsewhere
    path('sheet/new/sheet_detail', views.sheet_detail, name='new_sheet_detail'),
