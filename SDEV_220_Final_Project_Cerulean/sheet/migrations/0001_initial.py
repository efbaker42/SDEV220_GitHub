# Generated by Django 5.0.5 on 2024-05-09 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abilities_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='sheet.abilities')),
            ...
            bases=('sheet.abilities', 'sheet.player_entry'),
        ),
        migrations.CreateModel(
            name='Sheet',
            fields=[
